...
<div class="container">
                ...
                <div class="col-md-6 mx-auto">
                    <form action="{{ $fiscalYear->id ? route('fiscal-year.update', $fiscalYear) : route('fiscal-year.store') }}" method="POST" class="form">
                        ...
                        <div class="form-group">
                            <label class="required" for="input-fiscal-year">आर्थिक वर्ष</label>
                            <input type="text" id="input-fiscal-year" name="name" class="form-control font-roboto" value="{{ old('name', $fiscalYear->name) }}">
                        </div>
                        <div class="form-group">
                            <label class="required" for="input-fiscal-year-start">सुरु मिति</label>
                        ...
                        <div class="form-group">
                            <label class="required" for="input-fiscal-year-end">समाप्त मिति</label>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary z-depth-0 ml-0">{{ $fiscalYear->id ? 'अपडेट गर्नुहोस्' : 'सेभ गर्नुहोस्'}}</button>
                    </form>
                </div>
            </div>
    ...
    <div class="box">
        <div class="box__header">
            <h1 class="box__title d-inline-block">आर्थिक वर्षहरु</h1>
