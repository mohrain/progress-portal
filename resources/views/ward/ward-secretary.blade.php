...
<div class="card mt-2">
    <div class="box__header">
        <div class="d-flex justify-content-between align-items-center">
            <div class="box__title">वडा सचिव <i> ( वडा नं.{{ $ward->ward_id ? $ward->ward->name . '/' . $ward->name : $ward->name }})</i></div>
        </div>
    </div>
        ...
        <section class="box ">
            <div class="box__header">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    @empty($secretary)
                    @else
                        <form action="{{ route('ward.secretary.destroy', $ward) }}" method="post"
                            method="post">
                            @method('delete')
                            @csrf
            ...
            <div class="box__body">
                @empty($secretary)
                    <form action="{{route('ward.secretary.store',$ward)}}" method="POST" id="myForm"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card" style="height: 320px;">
                            <img id="newProfilePhotoPreview"
                                src="{{ $secretary->profile ? asset('storage/' . $secretary->profile) : asset('assets/img/no-image.png') }}"
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{ route('employees.show', $secretary) }}"
                                    class="">पुरा
                                    हेर्नुहोस्</a>
                            </div>
                        </div>
    ...
    <script>
        ...
        `;
            ...
            $("#myForm").submit(function(event) {
                ...
                if (!employee_id) {
                    errorMessageAlert('कृपया कर्मचारी चयन गर्नुहोस्');
                    return;
                }
