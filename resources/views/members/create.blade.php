                        ...
                        <div class="row">
                            <div class="col-md-9 order-lg-0 order-1">
                                <div class="row">
                                    ...
                                    <div>
                                        <input type="hidden" name="election_district" value="kailali" id="election_district">
                                    </div>
                                    <!-- <div class="col-md-4 mb-2">
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="designation" class="form-label required">पद</label>
                                    <select class="form-control" name="office_bearer_designation_id" id="office_bearer_designation_id">
                                        ...
                                        <option value="{{ $designation->id }}"
                                            data-requires-ward="{{ $designation->type=='ward' ? '1' : '0' }}"
                                            {{ (old('office_bearer_designation_id', $member->office_bearer_designation_id) == $designation->id) ? 'selected' : '' }}>
                                            {{ $designation->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="col-md-4 mb-2" id="ward-container" style="display: none;">
                                        ...
                                        <select class="form-control" name="ward_number" id="ward_number" >
                                            ...
                                            @foreach ($wardNumbers as $ward)
                                                <option value="{{ $ward }}"
                                                    {{ (old('ward_number', $member->ward_number) == $ward) ? 'selected' : '' }}>
                                                    {{ $ward }}
                                                </option>
                                            @endforeach
                                        </select>
...
<script>
    ...
    function toggleWardField() {
        const select = document.getElementById('office_bearer_designation_id');
        const selectedOption = select.options[select.selectedIndex];
        const requiresWard = selectedOption.getAttribute('data-requires-ward') == '1';
        const wardContainer = document.getElementById('ward-container');

        wardContainer.style.display = requiresWard ? 'block' : 'none';
    }

    // Run on load (in case of edit)
    document.addEventListener('DOMContentLoaded', function () {
        toggleWardField();
        document.getElementById('office_bearer_designation_id').addEventListener('change', toggleWardField);
    });
</script>
