<table class="table table-striped table-hover bg-white">
    ...
    <tbody>
        ...
        @push('scripts')
        <script>
            // document.getElementById("date_bs_table-{{ $meeting->id }}").innerHTML = NepaliFunctions.GetBsFullDate(NepaliFunctions.AD2BS("{{ $meeting->date }}", 'YYYY-MM-DD'), 'YYYY-MM-DD', "YYYY-MM-DD");
            document.getElementById("date_bs_table-{{ $meeting->id }}").innerHTML = NepaliFunctions.AD2BS("{{ $meeting->date }}", "YYYY-MM-DD");
