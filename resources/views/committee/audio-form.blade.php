...
<div class="container-fluid">
    ...
    <section class="box mt-4">
        ...
        <div class="box__body">
            ...
            <form action="{{$committeeAudio->id ? route('committee.update.audio',[$committee,$committeeAudio]) :  route('committee.store.audio',$committee)}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>नाम</label>
                            <input type="text" class="form-control" value="{{old('name',$committeeAudio->name)}}" name="name" id="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
