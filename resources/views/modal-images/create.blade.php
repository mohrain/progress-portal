@extends('layouts.app', ['title' => __('मोडाल फोटो सिर्जना')])
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ $modalImage->id ? route('modal-images.update', $modalImage) : route('modal-images.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3 text-right">
                                    <button type="submit" class="btn btn-primary">
                                        {{ $modalImage->id ? 'सम्पादन' : 'सुरक्षित' }}
                                    </button>
                                </div>
                            </div>
                        </form>
