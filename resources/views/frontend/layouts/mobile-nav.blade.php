...
<nav class="navbar fixed-bottom navbar-light bg-white shadow-lg border-top d-md-none d-block">
    <div class="container d-flex justify-content-around">
        ...
        <a href="{{ route('department.index') }}" class="nav-item text-center text-decoration-none text-muted">
        ...
        <!-- Drop CV -->
        <a href="{{ route('post-categories.show', 5) }}" class="nav-item text-center text-decoration-none text-muted">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
