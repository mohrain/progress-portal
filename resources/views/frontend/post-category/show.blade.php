                ...
                <form action="{{ route('posts.frontendSearch', $postCategory) }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <input type="text" name="created_date_from"
                                class="form-control kalimati-font nepali-date-picker @error('created_date_from') is-invalid @enderror"
                                value="" id="bill_date_from" aria-describedby="bill_date_from">

                        </div>
                        <div class="col-md-3 mb-2">
                            <label for="created_date_to" class="form-label">अन्त्य मिति</label>
                            <input type="text" name="created_date_to"
                                class="form-control kalimati-font nepali-date-picker @error('created_date_to') is-invalid @enderror"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-secondary">
                                      published:  {{ ad_to_bs($post->created_at->format('Y-m-d')) }}
                                    </small>
                                </td>
