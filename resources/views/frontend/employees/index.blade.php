    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-5 ">
            ...
            <div class="box p-3">
                @if (request()->route()->getName() === 'employees.frontendSearchOld' ||
                request()->route()->getName() === 'employees.frontendIndexOld')
                <form action="{{ route('employees.frontendSearchOld') }}" method="get">
                    @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" name="branch" class="form-control @error('branch') is-invalid @enderror"
                                    value="" id="branch" aria-describedby="branch">
                    ...
                    <tr>
                        <td class="sort-handle">
                            <img id="newProfilePhotoPreview"
                                src="{{ $employee->profile ? asset('storage/' . $employee->profile) : asset('images/user.png') }}"
                                class="profile-nav">
                        </td>
                        <td>
                            <div class="fw-bold">
                        ...
                        <td>
                            ...
                            <div class="kalimati-font">कार्यकालः {{ $employee->joining_date ?? '-' }} देखि
